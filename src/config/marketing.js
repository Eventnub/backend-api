const questions = [
  ...
  {
    id: 2,
    question: "What is the title of Burna Boy’s first official song?",
    options: ["Tonight", "Yawa Dey", "Last Last", "Like to Party"],
    correctAnswer: "Like to Party"
  },
  {
    id: 3,
    question: "Who is the father of Afrobeat?",
    options: ["Sunny Ade", "Wizkid", "Fela Kuti", "2baba"],
